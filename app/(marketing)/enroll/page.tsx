  ...
  if (status === "success") {
    return (
      <div className="px-4 py-24 text-center sm:px-6">
        <FadeIn>
          <h1 className="font-display text-3xl font-bold text-gold">Application Received!</h1>
          <p className="mt-4 text-kaizen-muted">We&apos;ll contact you shortly to schedule your first class.</p>
        </FadeIn>
      </div>
    );
  }
  ...
  return (
    <div className="px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-2xl">
        <FadeIn>
          <SectionHeading title="Enroll Now" subtitle="Start your martial arts journey" />
        </FadeIn>
        <form onSubmit={handleSubmit} className="mt-12 space-y-6 rounded-xl border border-blue/20 bg-kaizen-dark p-8">
