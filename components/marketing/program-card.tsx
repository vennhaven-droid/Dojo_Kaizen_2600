...
export function ProgramCard({ name, tagline, imageSrc }: ProgramCardProps) {
  const src = getProgramImage(name, imageSrc);
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-xl border border-blue/30 bg-kaizen-dark transition-all hover:border-gold/40">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <Button asChild variant="gold" size="sm" className="mt-4 w-full shrink-0 min-h-11">
